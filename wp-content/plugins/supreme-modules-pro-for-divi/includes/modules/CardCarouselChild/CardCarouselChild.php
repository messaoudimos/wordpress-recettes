...
class DSM_CardCarousel_Child extends ET_Builder_Module {
	...
	public function render( $attrs, $content, $render_slug ) {
		...
		$stretch_image                       = 'on' === $global_stretch_image ? $global_stretch_image : $this->props['stretch_image'];
		...
		$image_css = sprintf(
			'dsm_card_carousel_child_img %1$s%2$s%3$s%4$s',
			...
			'off' !== $stretch_image ? ' dsm_card_carousel_image_stretch' : '',
			'on' === $dsm_card_carousel_setting['lazyload'] ? ' swiper-lazy' : ' skip-lazy'
		);
